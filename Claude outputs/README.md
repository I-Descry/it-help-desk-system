...
- [`flow-1-ticket-routing.md`](./flow-1-ticket-routing.md) — the built and tested Power Automate flow: Ticket ID minting, Manual-mode Teams approval, and Auto-mode round-robin assignment, including exact expressions and build gotchas
...
- [Ticket Assignment & Absence Routing (diagram)](https://claude.ai/code/artifact/961716c9-3479-4ed1-b36f-670b5ffe41ed) — a visual flowchart of the same Manual/Auto/absence logic as `flow-1-ticket-routing.md`, hosted separately (not a file in this repo)
